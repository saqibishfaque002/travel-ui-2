...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-gray-800 mt-2">Add New Package</h1>
</div>
    ...
    <form action="{{ route('admin.packages.store') }}" method="POST">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                       ...
                       placeholder="Paris Romantic Getaway">
                @error('name')
        ...
        <div class="grid grid-cols-3 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="text" name="people" id="people" value="{{ old('people') }}" required
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="image" id="image" value="{{ old('image') }}" required
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
                   placeholder="eiffel-tower-paris.jpg">
        ...
        <div class="mb-4">
            ...
            <textarea name="features" id="features" rows="6" required
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
                      placeholder="4-Star Hotel&#10;Daily Breakfast&#10;City Tours&#10;Airport Transfer">{{ old('features') }}</textarea>
